                 ...
                 navbarPage(
                      ...
                      column(width=12,
                               p(strong("How does GenExAT App work?")),
                                     br(),
                                     "GenExAT is abbreviated for Gene Expression Analysis Tool.",
                                      br(),br(),
                                    "It is a web application that perform analysis based on different types of biological data, including microarray and bulk RNA-seq, single-cell RNA-seq and Exome-seq data. ",
                                     br(),br(),
